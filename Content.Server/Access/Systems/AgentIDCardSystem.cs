...
using Content.Shared._Emberfall.NanoChat; // Emberfall
...
namespace Content.Server.Access.Systems
{
    public sealed class AgentIDCardSystem : SharedAgentIdCardSystem
    {
        ...
        [Dependency] private readonly SharedNanoChatSystem _nanoChat = default!; // Emberfall
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<AgentIDCardComponent, AgentIDCardNumberChangedMessage>(OnNumberChanged); // Emberfall
        }
        ...
        private void OnAfterInteract(EntityUid uid, AgentIDCardComponent component, AfterInteractEvent args)
        {
            ...
            // Emberfall - Copy NanoChat data if available
        ...
        private void AfterUIOpen(EntityUid uid, AgentIDCardComponent component, AfterActivatableUIOpenEvent args)
        {
            ...
            var state = new AgentIDCardBoundUserInterfaceState(
                ...
                idCard.JobIcon,
                currentNumber); // Emberfall - Pass current number
